...
Phase 1A・1Bはマージ済みです。Phase 1Cではrun台帳と起点単位の安全なWorker再開を追加しました。計画は`planning/PHASE1C_PLAN.md`、契約は`appendix_d/docs/Phase1C_run台帳と再開.md`を参照してください。本番PostgreSQL、API/UI、分散Workerは未実装です。
