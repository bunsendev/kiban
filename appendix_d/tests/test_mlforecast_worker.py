"""MLForecast executorをAPIから独立Worker processまで通す。"""
...
def test_api_to_mlforecast_worker_artifact_restore_end_to_end(tmp_path) -> None:
    ...
    database = tmp_path / "mlforecast.sqlite3"
