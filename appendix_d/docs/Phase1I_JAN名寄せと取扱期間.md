...
この段階では規格・内容量・入数の自動抽出、JAN補正、自動承認、日次0補完、予定ファイル完全性、dataset snapshot自動発行を行わない。取扱期間の登録・履歴確認は後続の[Phase 1U専用画面](Phase1U_取扱期間と欠測判定画面.md)から、名寄せjob、候補、canonical product、判断履歴、JAN有効期間の操作は[Phase 1Y専用画面](Phase1Y_JAN名寄せ商品マスター画面.md)から行える。
