...
指定実データZIPの全ファイル照合、在庫mapping診断、出荷snapshotの再集計照合、Baseline・MLForecast Ridge・StatsForecast AutoETSの5条件比較は[実データによる予測OSS比較結果](docs/実データOSS比較結果_2026-09-19.md)を参照する。
